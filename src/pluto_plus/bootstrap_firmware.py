...
from pluto_plus.doctor import (
    ...
    FEATURE_103_RC11_FULL_RAM_POLICY,
    FEATURE_103_RC11_KERNEL_RAM_POLICY,
    FEATURE_103_RC11_PARENT_RAM_POLICY,
    FEATURE_103_RC11_REPACK_RAM_POLICY,
    FEATURE_103_RC11_RX0_RAM_POLICY,
...
# RC1--RC10 are deliberately absent from the executable profile registry after
...
for _feature_103_policy, _feature_103_counter_policy, _adaptive in (
    (FEATURE_103_RC11_PARENT_RAM_POLICY, COUNTER_RX_V1_RELEASE_RAM_POLICY, False),
    (FEATURE_103_RC11_REPACK_RAM_POLICY, COUNTER_RX_V1_RELEASE_RAM_POLICY, False),
    (FEATURE_103_RC11_KERNEL_RAM_POLICY, COUNTER_RX_V1_RELEASE_RAM_POLICY, True),
    (FEATURE_103_RC11_RX0_RAM_POLICY, COUNTER_RX_V1_1R1T_RAM_POLICY, True),
    (FEATURE_103_RC11_FULL_RAM_POLICY, COUNTER_RX_V1_1R1T_RAM_POLICY, True),
):
