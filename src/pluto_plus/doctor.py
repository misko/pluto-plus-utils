...
# Exact RC2 rebuild of the optional DDR-ring candidate. RC2 changes the iiOD
# producer's final sample boundary from inclusive to the ABI-3-defined exclusive
# value and adds checked arithmetic at that boundary. It remains RAM-only until
# the corrected bytes pass the complete physical USB/IP qualification matrix.
DDR_RING_V1_RC2_RAM_POLICY = FirmwarePolicy(
    profile_id="ddr-ring-v1-rc2-ram",
    release_tag="ddr-ring-v1-rc2-33fe77ca6319",
    device_firmware="v0.43-plutoplus-spf-ddr-ring-v1-rc2",
    asset_name="plutoplus-spf-ddr-ring-v1-rc2-33fe77ca6319-pluto.dfu",
    asset_sha256="0da8fc12ac8677b18b17f203903cd3e65dca171d31d65f6ba25c6d5702066f91",
    release_url="https://github.com/misko/plutosdr-fw/actions/runs/33230249900",
    source_commit="33fe77ca631961d5230e678fddc0d802f1522d68",
    fit_body_sha256="19476b9f88e80cff1bfc34f42ad78a090eb35b6dd08ebc8339b855db5380462e",
    fit_body_size=12_809_955,
    hardware_qualified=False,
...
# Exact final-version-stamped prefill image from protected main run
# 33268280819. Candidate evidence does not transfer to these byte-distinct
# objects, so this identity remains RAM-only until it repeats the focused
# physical-Ethernet ordinary/ring and recovery gates.
DDR_RING_PREFILL_V1_RELEASE_RAM_POLICY = FirmwarePolicy(
    profile_id="ddr-ring-prefill-v1-release-ram",
    release_tag="v0.44-plutoplus-spf-ddr-ring-prefill-v1",
    device_firmware="v0.44-plutoplus-spf-ddr-ring-prefill-v1",
    asset_name="plutoplus-spf-ddr-ring-prefill-v1-0c49d6837847-pluto.dfu",
    asset_sha256="eb7d39f2f456d79f005239ddcff204166c9c607cd3647f1dd90464f99f439925",
    release_url="https://github.com/misko/plutosdr-fw/actions/runs/33268280819",
    source_commit="0c49d6837847cefba9b139106dcffb1942f0ee22",
    fit_body_sha256="589a33b865161ac5820031ae0666d7b04b5346f0aad56fc422dd94a50f43c24d",
    fit_body_size=12_809_519,
    hardware_qualified=False,
...
# Exact RAM-only successor that keeps the timing instrumentation while pinning
# only per-device iiOD read/write workers to CPU1. The daemon's baseline pool
# mask remains available to nested DDR-ring producers, avoiding the whole-
# process affinity prototype's producer/transport serialization. No matching
# persistent profile exists.
IIO_THROUGHPUT_RW_AFFINITY_V2_RC1_RAM_POLICY = FirmwarePolicy(
    ...
    fit_body_sha256="0f975c56eceace56c4335f64c13ff4583951b4e695154251052389966b7c148c",
    fit_body_size=12_814_483,
    hardware_qualified=False,
...
# Exact RAM-only successor that retains v5's interruptible waits while renewing
# bounded sampler credit for the complete in-flight DMA queue. No matching
# persistent profile exists until repeated long-ring hardware qualification
# proves metadata closure, CPU behavior, and recovery on the spare radio.
IIO_THROUGHPUT_COVERAGE_WINDOW_V6_RC1_RAM_POLICY = FirmwarePolicy(
    ...
    fit_body_sha256="299ea1db5ffb2f16c52ec22e8078c1f64a09fd49cad544477ca08d21547676ca",
    fit_body_size=12_817_103,
    hardware_qualified=False,
...
# Exact non-RC bytes from protected main run 33408049625. This reviewed object
# authorizes volatile DFU only. The separate persistent-promotion policy does
# not exist until these bytes pass the final RAM, physical-1-GbE, recovery, RF,
# and persistent cold-boot qualification gates.
IQ_DIRECT_ASYNC_RING_V1_RELEASE_RAM_POLICY = FirmwarePolicy(
    profile_id="iq-direct-async-ring-v1-release-ram",
    release_tag="v0.46-plutoplus-spf-iq-direct-async-ring-v1",
    device_firmware="v0.46-plutoplus-spf-iq-direct-async-ring-v1",
    asset_name="plutoplus-spf-iq-direct-async-ring-v1-f182a8fa0811-pluto.dfu",
    asset_sha256="ac51893dac8a914621aa8eb6f5c65d324ae8f09812033aa4880dc1dad8e6d739",
    release_url="https://github.com/misko/plutosdr-fw/actions/runs/33408049625",
    source_commit="f182a8fa0811d2e70186b8f75d06ff4d5d896140",
    fit_body_sha256="8dc973cd808a49392d26e69336c3b5c32dbece6903f69b30698873caa1bf79c5",
    fit_body_size=12_821_527,
    hardware_qualified=False,
...
# Exact final-version-stamped bytes from protected main run 33481347855.  This
# identity is deliberately RAM-only until the same DFU passes the attached-radio
# fleet, physical-1-GbE, long-session, recovery, RF-restoration, and persistent
# cold-return gates.  The earlier locally built candidate remains a distinct
# immutable object and cannot be substituted for these trusted-build bytes.
IQ_DIRECT_ASYNC_V3_RELEASE_RAM_POLICY = FirmwarePolicy(
    profile_id="iq-direct-async-v3-release-ram",
    release_tag="v0.48-plutoplus-spf-iq-direct-async-v3",
    device_firmware="v0.48-plutoplus-spf-iq-direct-async-v3",
    asset_name="plutoplus-spf-iq-direct-async-v3-e3078376a6e1-pluto.dfu",
    asset_sha256="cc87c36a3aad609a64b45f4a02eecf916b99a3099fa523eed1bf4526ed98995a",
    release_url="https://github.com/misko/plutosdr-fw/actions/runs/33481347855",
    source_commit="e3078376a6e1a8c6ea841dc69966b3880e020c70",
    fit_body_sha256="db777ac93d5c6f0be0cf2799808a4d06fe39264ee1e99e76001509394d75f1df",
...
FEATURE_103_RC3_RAM_POLICY = FEATURE_103_RC2_RAM_POLICY.model_copy(
    update={
        "profile_id": "feature-103-rc3-ram",
        "release_tag": "feature-103-rc3-rx0-local-ram",
        "asset_name": "feature103-ram-v3.dfu",
        "asset_sha256": "7e5a551f5cfe9fd3d913527c5d4f3bcfb0b5d544301d5e96ab1ca0bbf2701fae",
        "source_commit": "21b0090b491a08256552913004c0453ee4d4c418",
        "fit_body_sha256": "565549cb08a2fe6245bddf863ccc6cfe3516e57a0dba0e2fe77322ca9039e3b2",
...
# RC11 keeps RC10's kernel and all-slot RX0 topology.  Its userspace gives
# adaptive feedback/ACK control a provider-lifetime lock independent of the
# stream transport lock, and returns every leased DMA block before destroying
# its parent libiio buffer during cancellation or disconnect teardown.
FEATURE_103_RC11_PARENT_RAM_POLICY = FEATURE_103_RC10_PARENT_RAM_POLICY.model_copy(
    update={
        "profile_id": "feature-103-rc11-parent-ram",
        "release_tag": "feature-103-rc11-byte-exact-parent-local-ram",
        "asset_name": "feature103-rc11-parent.dfu",
    }
)
FEATURE_103_RC11_REPACK_RAM_POLICY = FEATURE_103_RC10_REPACK_RAM_POLICY.model_copy(
    update={
        "profile_id": "feature-103-rc11-repack-ram",
        "release_tag": "feature-103-rc11-canonical-repack-local-ram",
        "asset_name": "feature103-rc11-repack.dfu",
    }
)
FEATURE_103_RC11_KERNEL_RAM_POLICY = FEATURE_103_RC10_KERNEL_RAM_POLICY.model_copy(
    update={
        "profile_id": "feature-103-rc11-kernel-ram",
        "release_tag": "feature-103-rc11-live-rfpll-kernel-local-ram",
        "asset_name": "feature103-rc11-kernel.dfu",
    }
)
FEATURE_103_RC11_RX0_RAM_POLICY = FEATURE_103_RC10_RX0_RAM_POLICY.model_copy(
    update={
        "profile_id": "feature-103-rc11-rx0-ram",
        "release_tag": "feature-103-rc11-all-fit-slots-rx0-local-ram",
        "asset_name": "feature103-rc11-rx0.dfu",
    }
)
FEATURE_103_RC11_FULL_RAM_POLICY = FEATURE_103_RC11_RX0_RAM_POLICY.model_copy(
    update={
        "profile_id": "feature-103-rc11-full-ram",
        "release_tag": "feature-103-rc11-full-local-ram",
        "device_firmware": "v0.50-plutoplus-feature103-rc11",
        "asset_name": "feature103-rc11-full.dfu",
        "asset_sha256": "d6c129c9562920e671826efeb3d3eebc0cd3cb95ac91d27fa59dadd9e718526c",
        "source_commit": "cb6b02ab4b995a370e54fe2f8a4623357e6413b4",
        "fit_body_sha256": "f4563a66b72c832abec4da78dc688c6153926922212c0de6ea5b2e2449d87067",
        "fit_body_size": 13_185_431,
    }
)
