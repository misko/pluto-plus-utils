...
DDR_RING_V1_RC1_PROFILE = DiagnosticProfile(
    profile_id="ddr-ring-v1-rc1",
    firmware_version="v0.43-plutoplus-spf-ddr-ring-v1-rc1",
    metadata_abis=(3,),
    tandem_agc_required=True,
    release_status="RAM-only optional DDR ring candidate; never persistence-qualified",
    release_rank=16,
)

DDR_RING_V1_RC2_PROFILE = DiagnosticProfile(
    profile_id="ddr-ring-v1-rc2",
    firmware_version="v0.43-plutoplus-spf-ddr-ring-v1-rc2",
    metadata_abis=(3,),
    tandem_agc_required=True,
    release_status="RAM-only optional DDR ring RC2 candidate; never persistence-qualified",
    release_rank=17,
)
...
DDR_RING_PREFILL_V1_RELEASE_PROFILE = DiagnosticProfile(
    profile_id="ddr-ring-prefill-v1",
...
IIO_THROUGHPUT_HOLD_V1_RC1_PROFILE = DiagnosticProfile(
    profile_id="iio-throughput-hold-v1-rc1",
    firmware_version="v0.45-plutoplus-spf-iio-throughput-hold-v1-rc1",
    metadata_abis=(3,),
    tandem_agc_required=True,
    release_status="RAM-only IIO HOLD throughput prototype; never persistence-qualified",
    release_rank=21,
)

IIO_THROUGHPUT_HOLD_V2_RC1_PROFILE = DiagnosticProfile(
    profile_id="iio-throughput-hold-v2-rc1",
    firmware_version="v0.45-plutoplus-spf-iio-throughput-hold-v2-rc1",
    metadata_abis=(3,),
    tandem_agc_required=True,
    release_status="RAM-only IIO HOLD refill-fence prototype; never persistence-qualified",
    release_rank=22,
)

IIO_THROUGHPUT_TIMING_V1_RC1_PROFILE = DiagnosticProfile(
    profile_id="iio-throughput-timing-v1-rc1",
    firmware_version="v0.45-plutoplus-spf-iio-throughput-timing-v1-rc1",
    metadata_abis=(3,),
    tandem_agc_required=True,
    release_status="RAM-only IIO stage-timing diagnostic; never persistence-qualified",
    release_rank=23,
)
...
IIO_THROUGHPUT_REFILL_SAMPLER_V4_RC1_PROFILE = DiagnosticProfile(
    profile_id="iio-throughput-refill-sampler-v4-rc1",
    firmware_version="v0.45-plutoplus-spf-iio-throughput-refill-sampler-v4-rc1",
    metadata_abis=(3,),
    tandem_agc_required=True,
    release_status=(
        "RAM-only refill-fenced metadata-sampler diagnostic; never persistence-qualified"
    ),
    release_rank=27,
)

IIO_THROUGHPUT_SAMPLER_WAKE_V5_RC1_PROFILE = DiagnosticProfile(
    profile_id="iio-throughput-sampler-wake-v5-rc1",
    firmware_version="v0.45-plutoplus-spf-iio-throughput-sampler-wake-v5-rc1",
    metadata_abis=(3,),
    tandem_agc_required=True,
    release_status=(
...
IQ_DIRECT_ASYNC_V4_RELEASE_PROFILE = DiagnosticProfile(
    profile_id="iq-direct-async-v4-release",
    firmware_version="v0.49-plutoplus-spf-iq-direct-async-v4",
    metadata_abis=(3,),
    tandem_agc_required=True,
    release_status="hardware-qualified exact DMA admission release",
    release_rank=36,
)

COUNTER_RX_V1_RELEASE_PROFILE = DiagnosticProfile(
    profile_id="counter-rx-v1-release",
    firmware_version="v0.50-plutoplus-spf-counter-rx-v1",
    metadata_abis=(3,),
    tandem_agc_required=True,
    release_status="hardware-qualified physical 1R1T counter metadata release",
    release_rank=37,
)
